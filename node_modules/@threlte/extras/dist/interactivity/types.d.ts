...
export type DomEventName = 'click' | 'contextmenu' | 'dblclick' | 'wheel' | 'pointerdown' | 'pointerup' | 'pointerleave' | 'pointerenter' | 'pointermove' | 'pointercancel';
export type EventOptions = Partial<Record<DomEventName, {
    passive?: boolean;
}>>;
