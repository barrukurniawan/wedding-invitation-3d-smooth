...
{#if !$isLoaded}
  <div class="absolute inset-0 z-50 flex flex-col items-center justify-center p-6 text-center" style="background: linear-gradient(160deg, #fff8ef 0%, #fbe6d8 55%, #f3cdbf 100%);">
    ...
    <h2 class="mt-4 font-serif text-2xl font-bold text-[var(--deep-rose)]">Halo, Undangan Yang Terhormat</h2>
    <p class="mt-2 max-w-sm text-sm text-[var(--ink)]/70">
      Sedang memuat undangan pernikahan Kia &amp; Toni. Harap tunggu sebentar...
    </p>
    <div class="mt-2 h-1.5 w-full max-w-sm overflow-hidden rounded-full border border-[var(--champagne)]/30 bg-white/50">
